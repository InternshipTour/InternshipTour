            ...
            <div class="with-padding">
                <div class="text-center margin-top-15">
                    <ul style="width: 205px;display: inline-block" class="nav nav-primary">
                        <li id="type_1" style="width: 100px"><a href="<?php echo U('topic?type=1');?>"> <?php echo L('hot_24');?></a>
                        </li>
                        <li id="type_2" style="width: 100px"><a href="<?php echo U('topic?type=2');?>"> <?php echo L('hot_7');?></a></li>
                    </ul>
                    <script>
                            ...
                            <?php if(is_array($topics["data"])): $i = 0; $__LIST__ = $topics["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item">
                                    <div class="item-content">
                                        ...
                                        <div class="text">
                                            ...
                                            <?php echo (text((isset($vo["intro"]) && ($vo["intro"] !== ""))?($vo["intro"]):L('chat_together'))); ?>
                                        </div>
                                        <div class="item-footer">
                                            <i class="icon-comments-alt"></i>
                                            <?php echo ($vo["weibos"]); ?></a>&nbsp;&nbsp;&nbsp;&nbsp; <i class="icon-eye-open"></i>
                                                <?php echo ($vo["read_count"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <?php if(($vo["uadmin"]) != "0"): ?><span class="text-muted"><?php echo L('presenter'); echo L('colon'); echo ($vo["user"]["space_link"]); ?></span>
                                                <?php else: ?>
                                                <?php echo L('presenter'); echo L('colon'); echo L('wait_for_you'); endif; ?>
