    ...
    <div class="col-xs-12">
        <div class="col-xs-12 weibo_content" style="padding: 0;position:relative;">
            <div class="weibo_icon">
                <?php if(check_auth('Weibo/Index/setTop')): if(($weibo["is_top"]) == "0"): ?><li data-weibo-id="<?php echo ($weibo["id"]); ?>" title="<?php echo L('set_top');?>" data-role="weibo_set_top">
                            <i class="icon icon-arrow-up"></i>
                        </li>
                        <?php else: ?>
                        <li data-weibo-id="<?php echo ($weibo["id"]); ?>" title="<?php echo L('cancel_top');?>" data-role="weibo_set_top">
                            <i class="icon icon-arrow-down"></i>
                        </li><?php endif; endif; ?>
                <?php if($weibo['can_delete']): ?><li data-weibo-id="<?php echo ($weibo["id"]); ?>" title="<?php echo L('delete');?>" data-role="del_weibo">
                        <i class="icon icon-trash"></i>
                    </li><?php endif; ?>
                <?php if($can_hide): ?><li data-weibo-id="<?php echo ($weibo["id"]); ?>" title="<?php echo L('hide_top');?>" data-role="hide_top_weibo">
            ...
            <div class="" style="padding: 10px 10px 5px 10px">
                ...
                <div class="col-xs-10" style="padding: 5px">
                    ...
                    <span>
                        ...
                        &nbsp;&nbsp;<span><?php echo L('from');?> <?php if($weibo['from'] == ''): echo L('pc');?> <?php else: ?><strong><?php echo ($weibo["from"]); ?></strong><?php endif; ?></span>
