...
<div id="main-container" class="container">
    ...
    <?php if($user_info['cover_id']): ?><img class="uc_top_img_bg" src="<?php echo ($user_info['cover_path']); ?>" style="width: 100%;height: 100%">
        <?php else: ?>
        <img class="uc_top_img_bg" src="/internship-tour/Application/Weibo/Static/images/user_top_default_bg.jpg" style="width: 100%;height: 100%"><?php endif; ?>
</div>
<div class="row uc_info">
            ...
            <dd>
                <div>
                    <div class="col-xs-6 text-center">
                        <a href="<?php echo U('Ucenter/Index/fans',array('uid'=>$user_info['uid']));?>" title="<?php echo L('fans_count');?>"><?php echo ($user_info["fans"]); ?></a><br><?php echo L('fans');?>
                    </div>
                    <div class="col-xs-6 text-center">
                        <a href="<?php echo U('Ucenter/Index/following',array('uid'=>$user_info['uid']));?>" title="<?php echo L('following_count');?>"><?php echo ($user_info["following"]); ?></a><br><?php echo L('follow');?>
                </div>
            </dd>
        </dl>
    </div>
    <div class="col-md-6 col-xs-8">
        <div class="uc_main_info">
            ...
            <div class="uc_m_b_12 text-more" style="width: 100%"><?php echo L('character_sign'); echo L('colon');?><span>
                <?php if($user_info['signature'] == ''): echo L('no_idea');?>
                    <?php else: ?>
                    <attr title="<?php echo ($user_info["signature"]); ?>"><?php echo ($user_info["signature"]); ?></attr><?php endif; ?>
            </span></div>
            <div class="uc_m_b_12">
                <span class="uc_m_r_36"><?php echo L('credits'); echo L('colon'); echo ($user_info["score"]); ?>&nbsp;&nbsp;
                </span>
            </div>
            <div class="uc_m_b_12"><span><?php echo L('grades'); echo L('colon'); echo ($user_info["title"]); ?></span></div>
            <?php if(!empty($user_info['tags'])): ?><div class="uc_m_b_12">
                    <span>
                        <?php echo L('individual_tags'); echo L('colon');?>
        ...
        <div class="col-xs-7 ">
            <div class="common-block ">
                <header class="clearfix ">
                    <div class="pull-left bottom-line"><?php echo L('detail');?></div>
...
<a title="<?php echo L('repost');?>"  data-role="send_repost"  href="<?php echo U('Weibo/Index/sendrepost',array('sourceId'=>$sourceId,'weiboId'=>$weibo['id']));?>"><?php echo L('repost');?> <?php echo ($weibo["repost_count"]); ?></a>


<div class=" col-xs-4" style="padding: 0px"><span class="cpointer" data-role="weibo_comment_btn"  data-weibo-id="<?php echo ($weibo["id"]); ?>">
    <?php echo L('comment');?> <?php echo ($weiboCommentTotalCount); ?>
</span>
</div>
                                        </div>
                                    </div>
        ...
        <div class="col-xs-5">
            <div class="common-block ">
                <header class="clearfix md">
                    <div class="pull-left bottom-line"><?php echo L('tip_favor_people');?></div>
                ...
                <section>
                    <?php if(empty($supported["data"])): ?><div style="width: 210px;margin: auto" class="alert with-icon">
                            ...
                            <div class="content"><?php echo L('tip_favor_nobody');?></div>
                        </div><?php endif; ?>
