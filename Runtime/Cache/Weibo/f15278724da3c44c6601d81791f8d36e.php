    ...
    <div class="row">
        <div class="col-xs-4 text-center" style="margin-left: 19px;">
            ...
            <a href="javascript:void(0)" data-role="do_checkin" class="btn-sign"
               style="color: red;font-weight: bolder;"><?php echo L('checkin');?></a>


            <?php }else{ ?>
            <a href="javascript:void(0)" class="btn-sign"><?php echo L('checked');?></a>
            <?php } ?>
        </div>
...
<div class="check-tab">
    <div class="col-xs-4 text-center active" data-role="change_rank" data-type="today"><?php echo L('today_checked');?></div>
    <div class="col-xs-4 text-center" data-role="change_rank" data-type="con"><?php echo L('con_checked');?></div>
    <div class="col-xs-4 text-center" data-role="change_rank" data-type="total"><?php echo L('total_checked');?></div>
</div>
