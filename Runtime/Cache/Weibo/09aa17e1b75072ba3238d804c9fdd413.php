    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <p><textarea class="form-control" id="repost_content" style="height: 6em;"
                         placeholder="<?php echo L('placeholder_something_to_write');?>"><?php echo ($weiboContent); ?></textarea></p>
            <a href="javascript:" onclick="insertFace($(this))"><img src="/internship-tour/Application/Core/Static/images/bq.png"/></a>
            <p class="pull-right"><input type="submit" value="<?php echo L('publish');?> Ctrl+Enter" data-role="do_send_repost"  data-weibo-id="<?php echo ($weiboId); ?>"  data-source-id = "<?php echo ($sourceId); ?>"
                                         class="btn btn-primary" data-url="<?php echo U('weibo/Index/doSendRepost');?>"/></p>
          <p><input id="becomment" type="checkbox" value="1" name="becomment" ><?php echo L('publish_as_common');?></p>
        </div>
    </div>
