<?php if (!defined('THINK_PATH')) exit();?><div class="weibo_post_box">
    <div class="row ">
        <div class="col-xs-12">
            <p>
                <input placeholder="说点什么吧～" id=""  data-weibo-id="<?php echo ($weiboId); ?>"
        ...
        <div class="col-xs-12" style="display: none">
            <p>
                ...
                <textarea placeholder="说点什么吧～" id="text_<?php echo ($weiboId); ?>" rows="2" data-weibo-id="<?php echo ($weiboId); ?>" class="form-control weibo-comment-content comment_text_inputor"></textarea>
            </p>
            <a href="javascript:" class="" onclick="insertFace($(this))"><img src="/internship-tour/Application/Core/Static/images/bq.png"/></a>
            <!--评论按钮-->
            <p class="pull-right ">
                <button class="btn btn-primary " data-role="do_comment" type="submit" id="btn_<?php echo ($weiboId); ?>" data-weibo-id="<?php echo ($weiboId); ?>">评论 Ctrl+Enter </button>
            </p>
        </div>
    </div>
...
<div style="width: 100%;height: 40px;text-align: center;line-height: 40px;">
    <a id="show_all_comment_<?php echo ($weiboId); ?>" href="javascript:" onclick="show_comment('<?php echo ($weiboId); ?>');">查看更多回复>></a>
</div>
<?php } ?>
