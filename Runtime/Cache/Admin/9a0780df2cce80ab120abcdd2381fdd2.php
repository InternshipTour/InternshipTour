...
<div class="panel-main" style="float:left;">
    ...
    <div class='pull-left icon-chose' title="选择icon">
        ...
        <select name="nav[1][icon][]" title="选择icon" class="chosen-icons" data-value="<?php echo ($icon); ?>"></select>
    </div>
...
<?php if($nav['child']){ ?>
    ...
    <div class="pull-left nav_list">
        <select name="nav[2][type][]" class="form-control nav-type" style="width: 100px;">
            <option value="module" <?php if($child['module_name']): ?>selected<?php endif; ?>>系统模块</option>
            <option value="custom" <?php if(!$child['module_name']): ?>selected<?php endif; ?>>自定义</option>
        </select>
        ...
        <input name="nav[2][title][]" placeholder="请输入标题" class="form-control title" style="width: 100px;" value="<?php echo ($child["title"]); ?>">

        <input name="nav[2][url][]" placeholder="请输入链接"  class="form-control url" style="width: 300px;<?php if($child['module_name']){ ?>display:none<?php } ?>" value=" <?php echo ($child["url"]); ?>">

    </div>
    <div class='pull-left icon-chose' title="选择icon">
        <select name="nav[2][icon][]" title="选择icon" class="chosen-icons" data-value="icon-<?php echo ((isset($child['icon']) && ($child['icon'] !== ""))?($child['icon']):''); ?>"></select>
    </div>
    <div class='pull-left color-chose' title="选择图标背景色">
    ...
    <div class='pull-left new-blank ' >
        ...
        <label title="新窗口打开" > <input class="target" <?php if($child['target'] == 1): ?>checked<?php endif; ?>  type="checkbox" value="1">新窗口打开</label>
    </div>
    ...
    <div class='pull-left band-text'>
        <input name="nav[2][band_text][]" class="form-control" placeholder="标志点文字"  style="width: 100px;" value="<?php echo ($child['band_text']); ?>">
    </div>
...
<div id="one-nav" class="hide">
    <li class="clearfix pLi" >
        ...
        <div class='pull-left icon-chose' title="选择icon">
            <select name="nav[1][icon][]" title="选择icon" class="chosen-icons" data-value="icon-<?php echo ($module["0"]["icon"]); ?>"></select>
        </div>
