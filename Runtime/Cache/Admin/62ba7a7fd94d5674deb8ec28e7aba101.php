...
<div class="with-padding">
    <div class="fl">
        <a href="<?php echo U('admin/expression/add');?>" class="btn">上传新表情</a>
    </div>
</div>
<!-- 数据表格 -->
<div class="with-padding">
    <table class="table table-bordered table-striped ">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$e): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><a href="<?php echo U('admin/expression/expressionlist',array('name'=>$e['name']));?>"><?php echo ($e['title']); ?></a></td>
                <td><a href="<?php echo U('admin/expression/expressionlist',array('name'=>$e['name']));?>"><?php echo ($e['name']); ?></a></td>
                <td><?php echo ($e['count']); ?></td>
                <td><?php echo ($e['status']?'启用':'禁用'); ?></td>
                <td>
                    <?php if($e['name'] != 'miniblog'){ ?>
                    <a href="<?php echo U('admin/expression/editpackage',array('name'=>$e['name']));?>">编辑</a>&nbsp;|&nbsp;<a class="ajax-get" href="<?php echo U('admin/expression/delpackage',array('name'=>$e['name']));?>">删除</a>
                    <?php } ?>
                </td>
