...
<div class="panel-main" style="float:left;">
    ...
    <div class="with-padding clearfix" style="">
        <ul class="pull-left nav nav-secondary">
            <li id="type_all"><a href="<?php echo U('lists',array('type'=>'all'));?>">全部</a></li>
            <li id="type_installed"><a href="<?php echo U('lists',array('type'=>'installed'));?>">已安装</a></li>
            <li id="type_uninstalled"><a href="<?php echo U('lists',array('type'=>'uninstalled'));?>">未安装</a></li>
            <li id="type_core"><a href="<?php echo U('lists',array('type'=>'core'));?>">系统模块</a></li>
            <script>
        ...
        <ul class="module-list">
            <?php if(is_array($modules)): $i = 0; $__LIST__ = $modules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="clearfix">
                    ...
                    <div class="content-wrapper">
                            ...
                            <div class="pull-right">
                                ...
                                <?php if(empty($vo["update_list"])): else: ?>
                                    <a style="text-decoration: none" href="javascript:void(0)" data-role="update_btn"
                                       ...
                                       data-toggle="modal" data-title="有新版本可以更新"><span class=" label label-success ">有新版<?php echo ($vo["update_list"]["0"]["title"]); ?></span></a>
                                    <script>$(function () {
                        ...
                        <div>开发者： <a style="color: #666"><?php echo ($vo["developer"]); ?></a></div>
                        <div class="clearfix bottom-btns">
                            <div class="pull-left">

                                <a class="btn btn-default"
                                   href="<?php echo U('edit?', array('name' => $vo['name']));?>">编辑</a>
                                <?php if($vo['can_uninstall'] ): if($vo['is_setup']): ?><a class="btn btn-danger"
                                           href="<?php echo U('uninstall', array('id' => $vo['id']));?>">卸载</a>
                                        <?php else: ?>
                                        <a class="btn btn-info"
                                           href="<?php echo U('install', array('name' => $vo['name']));?>">安装</a><?php endif; endif; ?>
                                <?php if(empty($vo["update_list"])): else: ?>
                                    <a class="btn btn-success"
                                       href="<?php echo U('Cloud/updateGoods',array('token'=>$vo['token']));?>">更新</a><?php endif; ?>
                            </div>
                            <div class="pull-right">
                                <?php if(empty($vo["token"])): ?><span class="label label-circle label-danger">本地模块</span>
                                    <?php else: ?>
                                    <a target="_blank"
                                       href="<?php echo appstoreU('Appstore/Index/goodsDetail',array('token'=>$vo['token']));?>"
                                       class="btn btn-info">去云市场查看</a><?php endif; ?>
                            </div>
                        </div>
                    </div>
                </li><?php endforeach; endif; else: echo "" ;endif; ?>
