...
<div class="panel-main" style="float:left;">
    ...
    <?php switch($form["type"]): case "text": ?><div class="controls">
            <input type="text" name="config[<?php echo ($o_key); ?>]" class="form-control text form-input-width" value="<?php echo ($form["value"]); ?>">
        </div><?php break;?>
    <?php case "password": ?><div class="controls">
            <input type="password" name="config[<?php echo ($o_key); ?>]" class="form-control text input-large form-input-width" value="<?php echo ($form["value"]); ?>">
        </div><?php break;?>
    ...
    <?php case "picture_union": ?><div class="controls">
        ...
        <script type="text/javascript">
            ...
            function uploadPicture<?php echo ($o_key); ?>(file, data){
                ...
                var src = '';
                if(data.status){
                    src = data.url || '/internship-tour' + data.path
                    $("#cover_id_<?php echo ($o_key); ?>").parent().find('.upload-img-box').append(
                            '<div class="upload-pre-item" val="' + data.id + '"><img src="/internship-tour' + src + '" ondblclick="removePicture<?php echo ($o_key); ?>(this)"/></div>'
                    );
                                    ...
                                    function uploadPicture<?php echo ($o_tab_key); ?>(file, data){
                                        ...
                                        if(data.status){
                                            ...
                                            $("#cover_id_<?php echo ($o_tab_key); ?>").parent().find('.upload-img-box').append(
                                                    '<div class="upload-pre-item" val="' + data.id + '"><img src="/internship-tour' + src + '" ondblclick="removePicture<?php echo ($o_tab_key); ?>(this)"/></div>'
                                            );
