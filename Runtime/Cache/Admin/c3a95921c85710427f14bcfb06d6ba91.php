...
<div class="panel-main" style="float:left;">
    ...
    <div class="tools auth-botton with-padding">
        ...
        &nbsp; &nbsp; &nbsp; &nbsp;
        <a class="btn" href="<?php echo U('Admin/menu/index');?>">后台菜单管理</a>
        <a class="btn" href="<?php echo U('Admin/menu/add');?>">新增后台菜单（后台权限节点）</a>
        <a class="btn" href="<?php echo U('addNode');?>">新增前台权限节点</a>
    </div>
	<!-- 数据列表 -->
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('AuthManager/access?group_name='.$vo['title'].'&group_id='.$vo['id']);?>" >后台管理授权</a>
                <a href="<?php echo U('AuthManager/accessuser?group_name='.$vo['title'].'&group_id='.$vo['id']);?>" >前台访问授权</a>
