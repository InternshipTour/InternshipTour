<?php if (!defined('THINK_PATH')) exit();?><div class="with-padding" style="margin-bottom:10px;">
...
<div class="with-padding">
    <table class="table table-bordered">
        ...
        <?php if(is_array($_list)): $vo = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lv): $mod = ($vo % 2 );++$vo;?><tr>
                <td style="width: 25px"><input class="ids" type="checkbox" name="id[]" value="<?php echo ($lv["id"]); ?>"></td>
