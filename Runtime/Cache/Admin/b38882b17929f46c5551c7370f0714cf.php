...
<div class="panel-main" style="float:left;">
	...
	<div class="clearfix with-padding">
		...
		<div class="search-form col-md-offset-10 col-xs-2 ">
			<div class="input-group">
				<input type="text" name="nickname" class="search-input form-control" value="<?php echo I('nickname');?>" placeholder="请输入用户昵称或者ID">
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
                <a href="<?php echo U('Rank/userRankList?id='.$vo['uid']);?>">用户头衔列表</a>
                <a href="<?php echo U('Rank/userAddRank?id='.$vo['uid']);?>">关联新头衔</a>
            </td>
...
<script type="text/javascript">
	...
	<script src="/internship-tour/Public/static/thinkbox/jquery.thinkbox.js"></script>
