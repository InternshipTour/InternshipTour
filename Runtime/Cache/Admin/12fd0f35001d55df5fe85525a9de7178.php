...
<div class="panel-main" style="float:left;">
    ...
    <div id="auth_groups" class="with-padding">
        <form class="form-horizontal" action="<?php echo U('addToGroup');?>" method="post" enctype="application/x-www-form-urlencoded" >
            ...
            <div class="clearfix">
                <?php if(is_array($auth_groups)): $i = 0; $__LIST__ = $auth_groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="checkbox checkbox-inline">
