...
<div class="panel-main" style="float:left;">
    ...
    <div class="with-padding">
        <a href="<?php echo U('Admin/Theme/add');?>" class="btn">安装新主题</a>
    </div>
    <div class="with-padding">
        <div class="cards plugin-list">
            <div style="width: 270px;padding: 0 10px;float: left;">
                <div class="card">
                    <div class="media-wrapper">
                         <img src="/internship-tour/Public/images/preview.jpg" style="height: 180px;">
                    </div>
                    ...
                    <div class="card-heading">
                        ...
                        <a href="<?php echo U('Admin/Theme/lookTheme',array('theme'=>'default'));?>" target="_blank" title="查看该主题">
                    ...
                    <div class="card-actions">
                        <div class="btn-group">
                            <?php if(($now_theme) == "default"): ?><span style="padding: 4px 12px;display: inline-block;font-size: 16px;color: #A5A5A5;">基础主题</span>
                                <?php else: ?>
                                <a class="btn btn-primary" data-role="use_this" data-value="default">只使用基础主题</a><?php endif; ?>
                        </div>
                    </div>
                </div>
            </div>
            <?php if(is_array($tplList)): $i = 0; $__LIST__ = $tplList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><div style="width: 270px;padding: 0 10px;float: left;">
                    <div class="card">
                        ...
                        <div class="card-heading">
                        <span class="pull-right">
                            <span class="label label-success" title="主题版本"><?php echo ($info["version"]); ?></span>
                        </span>
                            <a href="<?php echo U('Admin/Theme/lookTheme',array('theme'=>$info['file_name']));?>" target="_blank" title="查看该主题">
                        ...
                        <div class="card-actions">
                            <div class="text-mute">
                                开发者：<?php echo ($info["developer"]); ?>
                            </div>
                        </div>
                        <div class="card-actions">
                            <div class="text-mute">
                                模板文件名：<?php echo ($info["file_name"]); ?>
                            </div>
                        </div>
                        <div class="card-actions">
                            <div class="btn-group">
                                <?php if(($now_theme) == $info["file_name"]): ?><span class="pull-left" style="padding: 4px 12px;color: #3DC86E;display: inline-block;font-size: 16px;">正在使用</span>
                                    <a class="btn btn-primary" href="<?php echo U('Admin/Theme/packageDownload',array('theme'=>$info['file_name']));?>" style="margin-left: 8px;">打包下载</a>
                                    <?php else: ?>
                                    <a class="btn btn-primary" data-role="use_this" data-value="<?php echo ($info["file_name"]); ?>">使用</a>
                                    <a class="btn btn-primary" href="<?php echo U('Admin/Theme/packageDownload',array('theme'=>$info['file_name']));?>" style="margin-left: 8px;">打包下载</a>
                                    <a class="btn btn-primary" href="<?php echo U('Admin/Theme/delete',array('theme'=>$info['file_name']));?>" style="margin-left: 8px;">卸载删除</a><?php endif; ?>
                            </div>
                        </div>
                    </div>
