...
<form id="searchForm" method="get" action="<?php echo ((isset($searchPostUrl) && ($searchPostUrl !== ""))?($searchPostUrl):'/internship-tour/index.php?s=/admin/user/scorelist.html'); ?>" class="form-dont-clear-url-param">
...
<?php if(count($searches) > 0): ?><button class="btn submit-btn" url="?status=-1" target-form="ids" style="padding: 6px 16px;" onclick="toggle_search()">搜索</button><?php endif; ?>
            ...
            <div style="float: right;" >
                ...
                <form id="selectForm" method="get" action="<?php echo ((isset($selectPostUrl) && ($selectPostUrl !== ""))?($selectPostUrl):'/internship-tour/index.php?s=/admin/user/scorelist.html'); ?>" class="form-dont-clear-url-param">
    ...
    <script type="text/javascript" src="/internship-tour/Public/static/thinkbox/jquery.thinkbox.js"></script>
    <script type="text/javascript">
//        //搜索功能
