    ...
    <section>
        <div class="col-xs-12 col-sm-offset-1 register clearfix" style="margin-top: 50px;margin-bottom: 110px;background-color: white;padding: 10px;">
            ...
            <?php if($step == 'start'): ?><div class="col-xs-6">
                    <form class="" action="/internship-tour/index.php?s=/ucenter/member/step/step/finish.html" method="post">
...
<script src="/internship-tour/Public/js/ext/lazyload/lazyload.js"></script>
    ...
    <script src='/internship-tour/Application/Core/Static/js/form_check.js'></script>
    <script>
        // 验证密码长度
        $(function(){
