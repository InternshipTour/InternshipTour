                ...
                <div class="other_login_link row" >
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row">
                            ...
                            <div class="col-xs-6 text-right">
                                <?php if($vo['is_bind']): ?><a href="javascript:" class="btn btn-info" data-role="unbind" data-type="<?php echo ($vo["name"]); ?>"  data-url="<?php echo addons_url('SyncLogin://Ucenter/unbind');?>">
