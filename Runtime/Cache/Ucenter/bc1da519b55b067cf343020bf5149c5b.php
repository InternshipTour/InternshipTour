    ...
    <div id="center">
        <div id="center_base">
            ...
            <ul class="nav nav-secondary">
                <li class="active"><a href="#base" data-toggle="tab">我的积分</a></li>
                <li>
                    <a href="#level" data-toggle="tab">等级经验</a>
                </li>
                <li>
                    <a href="#rule" data-toggle="tab">积分获取规则</a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="base">
                    <div class="with-padding" style="padding: 20px">
                        <div class="col-xs-8">
                            <div class="panel">
                                <div class="panel-heading">现有积分</div>
                                <ul class="list-group">
                ...
                <div class="tab-pane" id="level">
                    <div class="with-padding" style="padding: 20px">
                        <div class="col-xs-8">
                            <div class="panel">
                                <div class="panel-heading">升级所需经验</div>
                                <ul class="list-group">
                                    <li class="list-group-item"><?php echo ($level); ?></li>
                                </ul>
                            </div>
                        ...
                        <div class="col-xs-12">
                            <div>
                                当前经验：<?php echo ($self["score"]); ?>
                            </div>
                            <div>当前等级：<?php echo ($self["title"]); ?></div>
                        </div>
                ...
                <div class="tab-pane" id="rule">
                    <div class="with-padding" style="padding: 20px">
                        <?php if(is_array($action_module)): $i = 0; $__LIST__ = $action_module;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?><div class="panel">
                                <div class="panel-heading"><?php echo ((isset($m["module"]["alias"]) && ($m["module"]["alias"] !== ""))?($m["module"]["alias"]):'系统'); ?></div>
                                <div class="list-group">
                                    <?php if(is_array($m["action"])): $i = 0; $__LIST__ = $m["action"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['rule_array'] != false): ?><a class="list-group-item"><h4 class="list-group-item-heading"><strong><?php echo ($vo["title"]); ?>
                                                ：</strong></h4>
                                                <?php if(is_array($vo["rule_array"])): $i = 0; $__LIST__ = $vo["rule_array"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><p class="list-group-item-text">
                                                        每次【<?php echo ($r["score"]["title"]); ?>】【<?php echo ($r["rule"]); ?>】<?php echo ($r["score"]["unit"]); ?>
                                                        ，每【<?php echo ($r["cycle"]); ?>】小时最多【<?php echo ($r["max"]); ?>】次</p><?php endforeach; endif; else: echo "" ;endif; ?>
