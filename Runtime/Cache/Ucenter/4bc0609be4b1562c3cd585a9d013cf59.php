...
<div id="uploader-demo">
    ...
    <div id="upload_avatar_<?php echo ($uid); ?>" style="padding: 20px 0">选择图片</div>
    ...
    <div class="show_avatar">
        ...
        <div class="col-xs-4 avatar_select" >
            ...
            <input class="btn btn-default avatar_btn" data-role="avatar_btn"  type="button" value="保存头像"/>
        </div>
...
<link rel="stylesheet" type="text/css" href="/internship-tour/Public/static/jcrop/jquery.Jcrop.css"/>
<script src="/internship-tour/Public/static/jcrop/jquery.Jcrop.js"></script>
<script src="/internship-tour/Public/static/browser/jquery.browser.js"></script>
