...
<div id="main-container" class="container">
    ...
    <?php
 $img_id = modC('JUMP_BACKGROUND','','config'); if($img_id){ $background =get_cover($img_id,'path'); }else{ $background = '/internship-tour/Public/images/jump_background.jpg'; } ?>
...
<?php }?>
    ...
    <p class="jump">
        ...
        或 <a href="http://<?php echo ($_SERVER['HTTP_HOST']); ?>/internship-tour" style="color: green">返回首页</a>
    </p>
