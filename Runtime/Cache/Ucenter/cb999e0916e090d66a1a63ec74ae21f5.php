                ...
                <div class="col-xs-12">
                    <?php if(!empty($tag_list)): if(is_array($tag_list)): $i = 0; $__LIST__ = $tag_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag_group): $mod = ($i % 2 );++$i;?><div class="tag-select-block clearfix">
                                ...
                                <div class="select-option">
                                    <?php if(is_array($tag_group['tag_list'])): $i = 0; $__LIST__ = $tag_group['tag_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag): $mod = ($i % 2 );++$i;?><div class="one_tag"><a class="btn btn-default" data-role="add_tag" data-id="<?php echo ($tag["id"]); ?>"><?php echo ($tag["title"]); ?></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                    ...
                    <div class="tag-select-block clearfix">
                        <div class="select-cate">个人标签：</div>
                        <div class="select-option my-tag-block">
                            <div data-role="my_tag_block">
                                <?php if(is_array($my_tag)): $i = 0; $__LIST__ = $my_tag;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag): $mod = ($i % 2 );++$i;?><div class="one_tag"><span class="btn btn-default"><?php echo ($tag["title"]); ?> <a class="icon-remove" data-role="remove_tag" data-id="<?php echo ($tag["id"]); ?>"></a></span></div><?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                    ...
                    <div class="tag-select-block clearfix">
                        <div class="select-option">
                            <button class="btn btn-primary" data-role="set-tag">保存</button>
                        </div>
                    </div>
                </div>
            </div>
