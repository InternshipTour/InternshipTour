...
<script src="/internship-tour/Public/js.php?f=js/jquery-2.0.3.min.js,js/com/com.functions.js,js/core.js,js/com/com.toast.class.js,js/com/com.ucard.js"></script>
    ...
    <link href="/internship-tour/Application/Ucenter/Static/css/center.css" rel="stylesheet" type="text/css"/>
    <link href="/internship-tour/Application/Ucenter/Static/css/usercenter.css" rel="stylesheet" type="text/css"/>
...
<div id="main-container" class="container">
    ...
    <?php if($user_info['cover_id']): ?><img class="uc_top_img_bg" src="<?php echo ($user_info['cover_path']); ?>" style="width: 100%;height: 100%">
        <?php else: ?>
        <img class="uc_top_img_bg" src="/internship-tour/Application/Ucenter/Static/images/user_top_default_bg.jpg" style="width: 100%;height: 100%"><?php endif; ?>
    <?php if(is_login() && $user_info['uid'] == is_login()): ?><div class="change_cover"><a data-type="ajax" data-url="<?php echo U('Ucenter/Public/changeCover');?>" data-toggle="modal" data-title="上传个人封面" style="color: white;"><img class="img-responsive" src="/internship-tour/Application/Core/Static/images/fractional.png"></a>
        </div><?php endif; ?>
</div>
