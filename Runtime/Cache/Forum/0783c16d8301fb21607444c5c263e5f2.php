...
<div class="clearfix">
    ...
    <div class="col-xs-10">
        ...
        <div class="row common_block_title">
            <?php echo L('post_list');?>
            <div class="pull-right text-right" style="margin-right: 15px">
                <div class="btn-group forum_order">
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                        <?php if(($order) == "0"): echo L('reply_time'); else: echo L('deliver_time'); endif; ?> <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu text-left" role="menu">
                        <li><a href="<?php echo U('forum',array('id'=>$forum_id,'order'=>'ctime'));?>"><?php echo L('deliver_time');?></a></li>
                        <li><a href="<?php echo U('forum',array('id'=>$forum_id,'order'=>'reply'));?>"><?php echo L('reply_time');?></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <p class="text-muted author">
            ...
            <?php echo L('reply');?>：<?php echo (friendlydate($vo["last_reply_time"])); ?>
                ...
                <div class="pull-right">
                    <?php echo getPagination($totalCount, modC('FORM_POST_SHOW_NUM_PAGE','10','Forum'));?>
                </div>
            </section>
        </div>
    </div>
...
<nav class="menu" data-toggle="menu">
    <?php if(check_auth('Forum/Index/addPost',get_expect_ids(0,0,0,forum_id,0))&&forumAllowCurrentUserGroup($forum_id)): ?><a class="btn btn-primary btn-md" href="<?php echo U('Index/edit',array('forum_id'=>$forum_id));?>"><i
                class="icon-edit"></i> <?php echo L('publish_post');?></a><?php endif; ?>

    <?php $myForums=D('Forum')->getFollowForums(is_login()); ?>

    <ul class="nav nav-primary" style="background: #ffffff">
        <li class="show">
            <a href="#"><i class="icon-heart"></i> <?php echo L('my_follow');?></a>
            <ul class="nav">
