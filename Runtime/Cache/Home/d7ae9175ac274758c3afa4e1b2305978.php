<?php if (!defined('THINK_PATH')) exit(); switch($type): case "today": ?><div class="check_rank ">
            <?php if(empty($rank)): ?><div class="default text-center" style="padding: 10px 0;"><?php echo L('nobody_checked');?></div>
                <?php else: ?>
                <ul class="check_rank_list">
                    <?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="row" style="margin-bottom: 10px;">
                            <div class="paiming col-xs-2" style="line-height: 32px">
                                <?php echo ($i); ?>
                            </div>
                            <div class="list col-xs-6">
                                <img class="avatar-img" style="width: 32px" src="<?php echo ($v["user"]["avatar32"]); ?>">
            ...
            <div class="col-xs-12"  style="text-align:center;line-height:28px;border-top: 1px rgb(240, 240, 240) dashed;">
                <a href="<?php echo addons_url('CheckIn://CheckIn/ranking');?>" style="padding: 0;color:rgb(51, 51, 51);">
                    <span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;<?php echo L('check_rank');?></a>
            </div>
            ...
            <ul class="check_rank_list">
                <?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-xs-5 ">
                            ...
                            <div class="pull-left">
                                <?php echo ($type_ch); echo ($type=='con'?$v['con_check']:$v['total_check']); echo L('day');?>
                            </div>
                        </div>
                        <div class="col-xs-4">
