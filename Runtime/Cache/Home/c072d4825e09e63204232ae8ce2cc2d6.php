            ...
            <div class="common-block" style="margin:0 10px;">
                <div style="margin:0 -10px;">
                    <div class="col-xs-9">
                        <div>
                            <h2>
                                <?php echo modC('FORUM_POST_SHOW_TITLE', L('post_hot'), 'Forum');?>
                            </h2>
                                        ...
                                        <div class="col-xs-10">
                                            <p>
                                                ...
                                                <?php if(($document["is_top"]) == "2"): ?><span class="label label-badge label-danger"><?php echo L('all_site');?></span>
                                                    <?php else: ?>
                                                    <?php if(($document["is_top"]) == "1"): ?><span class="label label-badge label-info"><?php echo L('block');?></span><?php endif; endif; ?>
                                            </p>
                                            ...
                                            <p class="text-muted author">
                                                ...
                                                <?php echo L('publish'); echo L('colon'); echo (friendlydate($vo["create_time"])); ?> |
                                                <?php echo L('last_reply_time'); echo L('colon'); echo (friendlydate($vo["last_reply_time"])); ?>
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xs-3">
                        <div>
                            <h2><?php echo modC('FORUM_SHOW_TITLE', L('forum_block'), 'Forum');?></h2>
                                ...
                                <?php if(is_array($forum_show)): $i = 0; $__LIST__ = $forum_show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="clearfix">
                                        ...
                                        <div class="col-xs-4 text-ellipsis">
                                            ...
                                            <div class="text-muted">
                                                <?php echo L('post'); echo L('colon'); echo ($vo["post_count"]); ?>
                                            </div>
                                        ...
                                        <div class="col-xs-4">
                                            <?php if(($vo["hasFollowed"]) == "1"): ?><a class="follow-simple" data-role="followingSimple"
                                                   ...
                                                   data-id="<?php echo ($vo["id"]); ?>"><span><?php echo L('minus');?> <?php echo L('followed');?></span> </a>
                                                <?php else: ?>
                                                <a class="follow-simple" onclick="forum.following_simple(this)" data-role="followingSimple"
                                                   data-id="<?php echo ($vo["id"]); ?>"><span><?php echo L('plus');?> <?php echo L('followers');?></span> </a><?php endif; ?>
                                        </div>
        ...
        'following_simple': function (obj) {
            ...
            $.post(U('Forum/index/doFollowing'), {id: id}, function (msg) {
                ...
                if (msg.status == 1) {
                    if(msg.follow==0){
                        $obj.each(function(){
                            $(this).find('span').text("<?php echo L('plus');?> <?php echo L('followers');?>");
                        })
                    }else{
                        $obj.each(function(){
                            $(this).find('span').text("<?php echo L('minus');?> <?php echo L('followed');?>");
                        })
                    }
                }
            })
